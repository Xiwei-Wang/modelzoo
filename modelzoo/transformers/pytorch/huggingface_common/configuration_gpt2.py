...
class GPT2Config(PretrainedConfig):
    ...
    Args:
        ...
        use_position_embedding (:obj:`bool`, `optional`, defaults to :obj: True):
            Whether to use position embeddings at the input of the model (learned).
        use_projection_bias_in_attention (:obj:`bool`, `optional`, defaults to :obj: True):
            Adds bias to Q,K,V projections in the Attention layer, if True.
        use_ffn_bias_in_attention (:obj:`bool`, `optional`, defaults to :obj: True):
            Adds bias in the concluding FFN in the Attention layer, if True.
        use_ffn_bias (:obj:`bool`, `optional`, defaults to :obj: True):
            Adds bias in all dense layers of the decoder's ffn sublayer, if True.
        use_ffn_bias (:obj:`bool`, `optional`, defaults to :obj: True):
            Adds bias in all dense layers of the decoder's ffn sublayer, if True.
        use_bias_in_output (:obj:`bool`, `optional`, defaults to :obj: False):
            Adds bias to output dense layer, if True
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_bias_in_output = use_bias_in_output
